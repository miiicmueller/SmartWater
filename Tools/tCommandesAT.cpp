...
const char* tCommandesAT::configSMS 		= "AT#SMSATRUNCFG=3,1,5"; //configuration des paramètres par défaut
const char* tCommandesAT::questWhiteList 	= "AT#SMSATWL?" ; // liste des numéros destinataires possibles
const char* tCommandesAT::addP41ToWhiteList = "AT#SMSATWL=0,1,0,\"+41*\""; // ajouter tous les numéros (de Suisse) en destinataires possibles
...
const char* tCommandesAT::questStatePIN 	= "AT+CPIN=?"; // état de la carte SIM ; savoir si elle est lockée
